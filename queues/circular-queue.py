...
# In a circular queue, the advantage is that when something is dequeued, the space can be reused, but this comes at the cost of more data storage needed due to needing to store both the data as well as a pointer.

# Code isn't finished, hopefully will be in the future.
